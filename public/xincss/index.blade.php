...
<header>
  ...
  <a href="/city/dalian">大连</a>
  <a href="/city/haierbin">哈尔滨</a>
  <a href="/city/shijiazhuang">石家庄</a></p>
  <p class="quyu">华东地区</p>                
  <p>                    
  <a href="/city/shanghai">上海</a>
  <a href="/city/hangzhou">杭州</a>
  <a href="/city/xiamen">厦门</a>
  <a href="/city/nanjing">南京</a>
  <a href="/city/suzhou">苏州</a>
  <a href="/city/wuxi">无锡</a>
  <a href="/city/ningbo">宁波</a>
  <a href="/city/fuzhou">福州</a>
  <a href="/city/qingdao">青岛</a>
  <a href="/city/hefei">合肥</a></p>
  <p class="quyu">中部西部</p>
  <p>                  
  ...
  <a href="/city/wuhan">武汉</a></p>
  <p class="quyu">华南地区</p>
  <p>                
   <a href="/city/guangzhou">广州</a>
   <a href="/city/shenzhen">深圳</a></p>        
       </div>       
        </div>
   <nav>            
...
<div class="focus">
    <div class="index">
    <h1 class="paitit">{{$city}}婚纱摄影排行榜</h1>
...
<div class="list">
		...
		<?php if(isset($oneinfo) && isset($oneinfo->id)) {?>
			<li>
                 <div class="num lft">
                     <em class="txtCtr">{{$oneinfo->order_city}}<span>TOP</span></em>
                    ...
                    <div class="txt-box">
                        ...
                        <div class="txt">
                            ...
                            <div class="hot txtCtr">
                                <a href="/dafen/{{$pycity}}/{{$oneinfo->id}}" rel="nofollow">点评打榜</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="pic-txt">
                    <div class="txt-box">
                        ...
                        <div class="txt">
                            ...
                            <div class="hot txtCtr">
                                <a href="/dafen/{{$pycity}}/{{$v->id}}" rel="nofollow">点评打榜</a>
                            </div>
                        </div>
                    </div>
                </div>
	...
	<script id="maintemp" type="text/html">
			...
			<li>
                 <div class="num lft">
                     <em class="txtCtr">@{{oneinfo.order_city}}<span>TOP</span></em>
                    <div class="txtCtr @{{if oneinfo.is_up==1}}s1@{{/if}}@{{if oneinfo.is_up==2}}s2@{{/if}}@{{if oneinfo.is_up==0}}s3@{{/if}}@{{if !oneinfo.is_up}}s3@{{/if}}  txt">@{{if oneinfo.is_up==0 || !oneinfo.is_up}}持平@{{/if}}@{{if oneinfo.is_up==1}}上升@{{oneinfo.is_up_num}}位@{{/if}}@{{if oneinfo.is_up==2}}下降@{{oneinfo.is_up_num}}位@{{/if}}</div>
                </div>
                <div class="pic-txt">
                    <div class="txt-box">
                        ...
                        <div class="txt">
                            ...
                            <div class="hot txtCtr">
                                <a href="http://ceshi.youbangkeyi.com/dafen/{{$pycity}}/@{{oneinfo.id}}">点评打榜</a>
                            </div>
                        </div>
                    </div>
                </div>
		...
		@{{each list as value index}}
			...
			<li>
                <div class="num lft">
					@{{if index<=3}}
						<em class="txtCtr">@{{value.order_city}}<span>TOP</span></em>
					@{{else}}
						<em class="txtCtr">@{{value.order_city}}<span>TOP</span></em>
					@{{/if}}
                ...
                <div class="pic-txt">
                    <div class="txt-box">
                        ...
                        <div class="txt">
                            ...
                            <div class="hot txtCtr">
                                <a href="http://ceshi.youbangkeyi.com/dafen/{{$pycity}}/@{{value.id}}">点评打榜</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<footer class="txtCtr">
<div class="tuijian">
<h3>{{$city}}优选婚纱摄影机构<span>(按综合实力排序)</span></h3>
<ul>
