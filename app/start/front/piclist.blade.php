                            ...
                            <div class="box">
                                <div class="title">
                                    <h4>
                                        ...
                                        <span>{{$name}}</span>
                                        <button style="float:right;width:100px;margin-top:-6px;"><a href="{{ url('shop/addclientpic/') }}/{{$id}}?tenantsId={{$tenantsId}}">添加客片</a></button>
                                    </h4>
                                </div>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                                <div class="controls center">
                                      				<a href="{{ url('shop/detailclientpic/') }}/{{ $info->id }}?tenantsId={{$tenantsId}}&taoxiId={{$id}}" title="客片详情" class="tip"><span>客片详情</span></a>
                                      				<a href="{{ url('shop/editclientpic/') }}/{{ $info->id }}?tenantsId={{$tenantsId}}&taoxiId={{$id}}" title="编辑客片" class="tip"><span>客片编辑</span></a>
                                                    <a href="{{ url('shop/delclientpic/') }}/{{ $info->id }}?tenantsId={{$tenantsId}}&taoxiId={{$id}}" title="删除" class="tip" class="del" onclick="return check();"><span>删除</span></a>
                                                </div>
                                            </td>
                                          </tr>
                                          <?php }?>
