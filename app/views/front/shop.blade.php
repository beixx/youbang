...
<div class="t2">营业时间：周一至周日 <span class="tc5">|</span>联系电话：{{$tenantinfo->phone}}</div>
<div class="t2"><span>商家地址：</span>{{$tenantinfo->address}}<em><a rel="nofollow" target="_blank" href="http://ditu.baidu.com/?s=s%26wd%3D{{$tenantinfo->name}}" >查看地图</a> </em></div>
    <div class="datas">
...
<a rel="nofollow" href="/dafen/{{$pycity}}/{{$tenantinfo->id}}">打榜</a></div></div></div>	  	<?php }?>    <div class="info-box">        <div class="infoTab" id="infoTab" style="position: static; top: 0px;">            <div class="tit paiming">                <ul>                    <li class="cur choose"><a href="#d_tab1">数据展示</a></li>                    <li class="choose"><a href="#d_tab2">精选套系</a></li> <li class="choose"><a href="#d_tab3">客片欣赏</a></li>   <li class="choose"><a href="#d_tab4">点评打榜</a></li>   </ul>            </div>        </div>        <div id="d_tab1" class="J_item hi-50"></div>
<div class="data">
...
<div class="info-box">        <div class="comment_list">            <div class="title fB">网友点评</div>                
<div class="dp-type">
	<a href="{{url('votelist')}}/{{$tenantinfo->id}}" class="all">全部</a>
 <div class="db txtCtr">
