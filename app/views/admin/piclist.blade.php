                                          ...
                                          <tr>
                                            ...
                                            <td>
                                                <div class="controls center">
                                      				<!-- <a href="{{ url('shop/detailclientpic/') }}/{{ $info->id }}?tenantsId={{$tenantsId}}&taoxiId={{$id}}"  class="tip"><span>客片详情</span></a> -->
                                      				<a href="{{ url('shop/editclientpic/') }}/{{ $info->id }}?tenantsId={{$tenantsId}}&taoxiId={{$id}}"  class="tip"><span>客片编辑</span></a>
                                                    <a href="{{ url('shop/delclientpic/') }}/{{ $info->id }}?tenantsId={{$tenantsId}}&taoxiId={{$id}}"  class="tip" class="del" onclick="return check();"><span>删除</span></a>
                                                </div>
                                            </td>
                                          </tr>
                                          <?php }?>
