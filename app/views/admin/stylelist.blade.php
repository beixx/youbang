...
<div id="content" class="clearfix">
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <!-- Build page from here: Usual with <div class="row-fluid"></div> -->
                            ...
                            <div class="box">
                                <div class="title">
                                    <h4>
                                        ...
                                        <span>{{$name}}</span>
                                        <button style="float:right;width:100px;margin-top:-6px;"><a href="{{url('shop/addstyle')}}/{{$id}}">添加风格</a></button>
                                    </h4>
                                </div>
                                <div class="content noPad">
                                    <table class="responsive table table-bordered">
                                        ...
                                        <tbody>
                                         <?php foreach($styles as $info){?>
                                          <tr>
                                          	<td><?php if(isset($info->name)){ echo $info->name; }?></td>
                                            <td>
                                                <div class="controls center">
                                      
                                                    <a href="{{ url('shop/delstyle/') }}/{{ $info->id }}?tenantsId={{$id}}" title="删除" class="tip" class="del" onclick="return check();"><span>删除</span></a>
                                                </div>
                                            </td>
                                          </tr>
                                          <?php }?>
 				...
 				<div class="center"><?php echo $styles->links(); ?></div>
                            </div><!-- End .box -->
