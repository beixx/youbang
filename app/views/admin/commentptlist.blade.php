                                          ...
                                          <tr>
                                            ...
                                            <td>
                                                <div class="controls center">
                                                	<a href="{{ url('commentpt/rebut/') }}/{{ $info->id }} " title="驳回" class="tip"><span>驳回</span></a>
                                                	<a href="{{ url('commentpt/accept/') }}/{{ $info->id }} " title="审核通过" class="tip"><span>审核通过</span></a>
                                                	<!-- <a href="{{ url('commentpt/add/') }}/{{ $info->tenantsId }} " title="添加商户评论" class="tip"><span>添加该商户评论</span></a> -->
                                                    <a href="{{ url('commentpt/editui/') }}/{{ $info->id }} " title="编辑" class="tip"><span>编辑</span></a>
                                                    <a href="{{ url('commentpt/delcomment/') }}/{{ $info->id }} " title="删除" class="tip" class="del" onclick="return check();"><span>删除</span></a>
                                                </div>
                                            </td>
                                          </tr>
                                          <?php }?>
