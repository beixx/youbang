                                            ...
                                            <td><?php if(isset($info->name)){ echo $info->name; }?></td>
                                             ...
                                             <td>
                                                <div class="controls center">
                                      				 <a href="{{ url('custom/edit/') }}/{{ $info->id }}" title="编辑" class="tip" ><span>编辑</span></a>
                                                    <a href="{{ url('custom/delete/') }}/{{ $info->id }}" title="删除" class="tip" class="del" onclick="return check();"><span>删除</span></a>
                                                </div>
                                            </td>
                                          </tr>
                                          <?php }?>
