            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        ...
                        <form class="form-horizontal seperator"  action="{{ url('shop/saveglobalclientpic') }}" method="post" id="loginForm" enctype="multipart/form-data" />
                                    ...
                                    <div class="row-fluid">
               							<div class="up-pic">
									        ...
									        <div class="pic-box" id="ImgFirstCoverRegin">
									            ...
									            <div class="pic lft" style="display:block;">
	                								<div class="close">
														<input type="hidden" name="firstcover[]" value="{{$v}}" id="user_bill" />
													</div>
	                								<img id="upload_img2" width="120px" src="{{asset($v)}}">
	            								</div>
									              <?php }}}?>
									        ...
									        <script type="text/html" id="ImgFirstCoverTemp">
									          ...
									          <div style="margin-top:20px;">点击上传套系封面图：<input class="weui-uploader__input" multiple="multiple"   type="file" accept="image/*" onchange="SeleFirstCoverImg(this);"/></div>
									   	</div>
                                    </div>
                                </div>
                            </div>
