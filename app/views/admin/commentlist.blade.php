                                          ...
                                          <tr>
                                            ...
                                            <td>
                                                <div class="controls center">
                                                    <a href="{{ url('comment/editui/') }}/{{ $info->id }} " title="编辑" class="tip"><span>编辑</span></a>
                                                    <a href="{{ url('comment/delcomment/') }}/{{ $info->id }} " title="删除" class="tip" class="del" onclick="return check();"><span>删除</span></a>
                                                </div>
                                            </td>
                                          </tr>
                                          <?php }?>
