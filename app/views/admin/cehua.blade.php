  ...
  <p>                
   ...
   <nav>            
      <a href="{{asset('city')}}/{{$pycity}}/sheying">首页</a>
            <a href="{{asset('city')}}/{{$pycity}}/sheying">婚纱摄影</a>
...
<div class="focus">
    <div class="index">
    <h1 class="paitit">{{$city}}婚礼策划排行榜</h1>
...
<div class="list">
		...
		<?php if(isset($oneinfo) && isset($oneinfo->id) && $oneinfo->id) {?>
			<li>
                 <div class="num lft">
                     <em class="txtCtr"><span style="padding-top:20px;">AD</span></em>
                                     </div>
                <div class="pic-txt">
                    <div class="txt-box">
                        ...
                        <div class="txt">
                            ...
                            <div class="t3"><span>品牌搜索<em><?php if($oneinfo->brand_search_num){ echo $oneinfo->brand_search_num; }else{ echo '-'; } ?></em>次/天</span><span>全网好评<em><?php if($oneinfo->praise_num){ echo $oneinfo->praise_num; }else{ echo '-'; } ?></em>条</span><span>全网差评<em><?php if($oneinfo->bad_num){ echo $oneinfo->bad_num; }else{ echo '-'; } ?></em>条</span></div>
                            <div class="tool">
                                <em class="txtCtr blue">{{$oneinfo->heat_index}}</em>
                                <div class="tooltip txtCtr">指数</div>
                            </div>
                            <div class="hot txtCtr">
                                <a rel="nofollow" href="/dafen/{{$pycity}}/<?php if(isset($oneinfo->id)){ echo $oneinfo->id; } ?>">打榜</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="pic-txt">
                    <div class="txt-box">
                        ...
                        <div class="txt">
                           ...
                           <div class="t3"><span>品牌搜索<em><?php if($v->brand_search_num){ echo $v->brand_search_num; }else{ echo '-'; } ?></em>次/天</span><span>全网好评<em><?php if($v->praise_num){ echo $v->praise_num; }else{ echo '-'; } ?></em>条</span><span>全网差评<em><?php if($v->bad_num){ echo $v->bad_num; }else{ echo '-'; } ?></em>条</span></div>
                            <div class="tool">
                                <em class="txtCtr blue">{{$v->heat_index}}</em>
                                <div class="tooltip txtCtr">指数</div>
                            </div>
                            <div class="hot txtCtr">
                                <a rel="nofollow" href="/dafen/{{$pycity}}/{{$oneinfo->id}}">打榜</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<footer class="txtCtr">
<div class="tuijian">
<h3>{{$city}}优选婚礼策划机构<span>(按综合实力排序)</span></h3>
<ul>
