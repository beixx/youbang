                            ...
                            <div class="box">
                                <div class="title">
                                    <h4>
                                        ...
                                        <span>{{$name}}</span>
                                        <button style="float:right;width:100px;margin-top:-6px;"><a href="{{url('shop/addadv')}}/{{$id}}">添加广告位</a></button>
                                    </h4>
                                </div>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                                <div class="controls center">
                                      				 <a href="{{ url('shop/editadv/') }}/{{ $info->id }}?tenantsId={{$id}}" title="编辑" class="tip" ><span>编辑</span></a>
                                                    <a href="{{ url('shop/deladv/') }}/{{ $info->id }}?tenantsId={{$id}}" title="删除" class="tip" class="del" onclick="return check();"><span>删除</span></a>
                                                </div>
                                            </td>
                                          </tr>
                                          <?php }?>
